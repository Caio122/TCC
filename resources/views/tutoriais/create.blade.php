...
@section('content')
    ...
    <div id="criar-tutorial-container" class="col-md-3 offset-md-4 mx-auto">
        ...
        <form action="{{ route('tutoriais.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- Adicionando Subtitulo do Tutorial -->
            <div class="form-group">
                ...
                <textarea id="sbtitulo" type="text" class="class form-control"  name="sbtitulo"
                    placeholder="Subtitulo do Tutorial" required autocomplete="sbtitulo"  wrap="soft"></textarea>
            </div>
